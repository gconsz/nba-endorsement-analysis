...
SQL scripts used for processing and cleaning are located in the [sql](https://github.com/gconsz/nba-endorsement-analysis/tree/main/sql/sql) folder of this repository.
